      ...
      <div style={{ maxWidth: '80rem', margin: '0 auto', padding: '0 1rem', width: '100%', position: 'relative', zIndex: 10 }}>
        <div style={{ maxWidth: '46rem', display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <h1 style={{ fontSize: 'clamp(2.5rem, 5.5vw, 4.25rem)', fontWeight: 900, letterSpacing: '-0.025em', lineHeight: 1.08, color: 'var(--hero-title-color)' }}>
              EXPERIENCE THE <br />
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem' }}>
            {[
              ...
              >
                ...
                <span style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--hero-card-text)' }}>{chip.text}</span>
              </div>
            ))}
          </div>
          ...
          <div style={{ 
            paddingTop: '1.5rem', 
            marginTop: '0.5rem',
            borderTop: '1px solid var(--hero-card-border)', 
            display: 'grid', 
