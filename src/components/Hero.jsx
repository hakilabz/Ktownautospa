    ...
    <section 
      style={{ 
        ...
        backgroundImage: `
          ...
          linear-gradient(to bottom, rgba(8,10,15,0.7) 0%, transparent 40%, #080a0f 100%),
          url('/hero-car.jpg')
        `,
      ...
      <div style={{ maxWidth: '80rem', margin: '0 auto', padding: '0 1rem', width: '100%', position: 'relative', zIndex: 10 }}>
        <div style={{ maxWidth: '44rem', display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <h1 style={{ fontSize: 'clamp(2.5rem, 5.5vw, 4.25rem)', fontWeight: 900, letterSpacing: '-0.025em', lineHeight: 1.08, color: 'white', textShadow: '0 4px 20px rgba(0,0,0,0.8)' }}>
              EXPERIENCE THE <br />
              <span className="gold-gradient-text">SHINE YOU DESERVE</span>
            </h1>
            <p style={{ fontSize: 'clamp(0.9375rem, 1.6vw, 1.1875rem)', color: '#cbd5e1', fontWeight: 400, lineHeight: 1.7, textShadow: '0 2px 10px rgba(0,0,0,0.9)' }}>
              Kingston's premier hand wash auto spa located at <strong style={{ color: 'white', fontWeight: 700 }}>36 Joseph St</strong>. Deep interior steam cleaning, paint correction, 
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem' }}>
            {[
              ...
              >
                ...
                <span style={{ fontSize: '0.75rem', fontWeight: 700, color: '#e2e8f0' }}>{chip.text}</span>
              </div>
            ))}
          </div>
