      ...
      <div style={{ maxWidth: '80rem', margin: '0 auto', padding: '0 1rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '2.5rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.875rem', lineHeight: 1.7, maxWidth: '28rem' }}>
            ...
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', background: 'rgba(212,175,55,0.12)', border: '1px solid rgba(212,175,55,0.4)', padding: '0.375rem 0.875rem', borderRadius: '9999px', fontSize: '0.75rem', fontWeight: 800, color: 'var(--gold-primary)', alignSelf: 'flex-start' }}>
              <ShieldCheck style={{ width: '1rem', height: '1rem', color: 'var(--gold-primary)' }} />
              ...
              <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '0.5rem', fontSize: '0.75rem', color: 'var(--text-muted)' }}>
                ...
                <li style={{ display: 'flex', alignItems: 'flex-start', gap: '0.5rem' }}>
                  ...
                  <div>
                    ...
                    <span style={{ fontSize: '0.6875rem', color: 'var(--text-muted)' }}>In-Shop Spa &amp; Mobile Service</span>
                  </div>
                </li>
              </ul>

              <div style={{ paddingTop: '0.5rem' }}>
                <span style={{ fontSize: '0.75rem', fontWeight: 800, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em', display: 'block', marginBottom: '0.5rem' }}>Service Quick Links</span>
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem', fontSize: '0.75rem', color: 'var(--text-muted)' }}>
                  <a href="#packages" style={{ color: 'var(--text-muted)', textDecoration: 'none', fontWeight: 600 }}>Medium Package</a>
                  <span>•</span>
                  <a href="#packages" style={{ color: 'var(--text-muted)', textDecoration: 'none', fontWeight: 600 }}>Full Detail</a>
                  <span>•</span>
                  <a href="#calculator" style={{ color: 'var(--text-muted)', textDecoration: 'none', fontWeight: 600 }}>Bug Removal ($5)</a>
                  <span>•</span>
                  <a href="#calculator" style={{ color: 'var(--text-muted)', textDecoration: 'none', fontWeight: 600 }}>Tire Shine ($10)</a>
                </div>
              </div>
            </div>
          </div>
