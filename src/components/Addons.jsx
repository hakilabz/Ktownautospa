...
export default function Addons({ onAddonToggle, selectedAddons = [] }) {
  const addonsList = [
    ...
    },
    {
      ...
      description: 'Dedicated deep foam scrub & hot water extraction for summer carpet floor mats.',
      highlight: false,
    },
    {
      id: 'engine-bay',
      ...
      description: 'Safe engine compartment degrease, steam clean, and protective satin dressing.',
      highlight: false,
    },
    {
      id: 'odour',
      ...
      description: 'Hospital-grade thermal disinfection that neutralizes smoke, mold, and biological odors at the source.',
      highlight: false,
    },
    {
      id: 'headlights',
      ...
      description: 'Multi-stage wet sanding and machine polishing to eliminate yellow oxidation and haze.',
      highlight: false,
    },
    {
      id: 'clay-bar',
      ...
      description: 'Pulls embedded rail dust, industrial fallout, and tree sap from clear coat for a glass-smooth surface.',
      highlight: false,
    },
    {
      id: 'heavy-surcharge',
      name: 'If it\'s extra dirty',
      price: 50,
      priceDisplay: '+$50',
      icon: <AlertTriangle className="w-6 h-6 text-red-400" />,
      description: 'Not automatic. Applies only when a vehicle needs significantly more work — heavy mess from kids, pets, or work vehicles.',
      highlight: false,
    },
  ];
